...
<section class="hero">
  <div class="container hero-grid">
    <div>
      <p class="eyebrow">✓ Estimation immobilière à Nandy</p>
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
        ...
        <div>
          ...
          <div style="background: var(--surface); border: 1px solid var(--border); border-radius: 12px; padding: 1.5rem; margin-bottom: 1.5rem;">
            ...
            <p style="margin: 0 0 1rem; font-weight: 600; font-size: 1rem;">Centre-ville, Nandy</p>
          ...
          <div style="background: linear-gradient(135deg, rgba(var(--primary-rgb), 0.05), rgba(var(--accent-rgb), 0.03)); border: 2px solid var(--accent); border-radius: 12px; padding: 1.5rem; margin-bottom: 1.5rem;">
            ...
            <div style="margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px solid var(--border);">
              ...
              <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0.8rem; text-align: center;">
                <div>
                  ...
                  <p style="margin: 0.3rem 0 0; font-weight: 700; font-size: 1.1rem; color: #e24b4a;">200 000 €</p>
                </div>
                <div style="border-left: 1px solid var(--border); border-right: 1px solid var(--border);">
                  ...
                  <p style="margin: 0.3rem 0 0; font-weight: 700; font-size: 1.1rem; color: var(--primary);">230 000 €</p>
                </div>
                <div>
                  <p style="margin: 0; color: var(--muted); font-size: 0.8rem;">Max</p>
                  <p style="margin: 0.3rem 0 0; font-weight: 700; font-size: 1.1rem; color: #22c55e;">260 000 €</p>
                </div>
              </div>
            </div>
            ...
            <div style="margin-bottom: 1rem;">
              ...
              <p style="margin: 0; font-weight: 700; font-size: 1rem;">
                <span style="color: var(--primary);">2 700 €</span>
            ...
            <div style="background: rgba(var(--primary-rgb), 0.05); border-radius: 8px; padding: 1rem; font-size: 0.9rem;">
              ...
              <p style="margin: 0; color: var(--muted); font-size: 0.85rem;">Centre de Nandy dynamique, proximité RER D, bon potentiel de vente dans le secteur.</p>
            </div>
  ...
  <div class="container">
    ...
    <div class="steps-grid">
      ...
      <article class="card step-card">
        ...
        <p>Une fourchette de prix cohérente avec la dynamique actuelle du marché local.</p>
        <a class="btn btn-small" href="#simulateur">Estimer mon bien</a>
      </article>
      <article class="card step-card">
