<section class="section page-hero">
  <div class="container">
    <div class="page-hero-inner card">
      ...
      <p class="lead">Informations éditoriales et juridiques relatives au site Estimation Immobilier Nandy.</p>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container card" style="display: grid; gap: 1.25rem;">
    ...
    <p>Maison d'Estimation Nandy — 15 Rue de l'Église, 77176 Nandy, France.</p>
